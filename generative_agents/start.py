...
# personas = [
#     "Aisha", "Klaus", "Maria", "Wolfgang",  # Students
#     "May", "John", "Eddie",  # Family: Professor, Pharmacy Owner, Student
#     "Jane", "Tom",  # Family: Housewife, Market Owner
#     "Carmen", "Tamara",  # Roommates: Supply Store Owner, Children's Book Writer
#     "Arthur", "Isabella",  # Bar Owner, Cafe Owner
#     "Sam", "Jennifer",  # Family: Retired Officer, Watercolor Painter
#     "Francisco", "Hailey", "Rajiv", "Latoya",  # Co-living: Comedian, Writer, Painter, Photographer
#     "Abigail", "Carlos", "George", "Ryan", "Yuriko", "Adam",  # Animator, Poet, Mathematician, Software Engineer, Tax Lawyer, Philosopher
# ]
...
personas = [
    ...
    #"Sam", "Jennifer",  # Family: Retired Officer, Watercolor Painter
    #"Francisco", "Hailey", "Rajiv", "Latoya",  # Co-living: Comedian, Writer, Painter, Photographer
    "Abigail", "Adam",  # Animator, Poet, Mathematician, Software Engineer, Tax Lawyer, Philosopher
]
